...
public class ventana_datos_llenado extends javax.swing.JFrame {

   
    public ventana_datos_llenado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 60, 210, 30));

        caja_costo_obra_perdida.setText("50000");
        getContentPane().add(caja_costo_obra_perdida, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 60, 120, 30));
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 100, 190, 30));

        caja_dia_perdido1.setText("1500");
        ...
        caja_precio_foranea1.setText("15000");
        ...
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 190, 220, 30));

        caja_preci_accidentes1.setText("5000");
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 230, 220, 30));

        caja_preci_per_perdido1.setText("500");
        ...
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 270, 220, 30));

        caja_multas1.setText("1500");
        ...
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 350, 220, 30));

        caja_carne_asada1.setText("2500");
        ...
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 390, 210, 30));

        caja_costo_laboratorio1.setText("4000");
        ...
        caja_precio_social.setText("2000");
        ...
        getContentPane().add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 150, 220, 30));

        caja_precio_popular.setText("3500");
        ...
        caja_costo_permisos.setText("3000");
        ...
        caja_fact_utilidad.setText("0.5");
    ...
    private void boton_simular1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_boton_simular1MouseClicked
        ...
        int mes_inicio,anio_inicio,cuadrillas_iniciales,cuadrillas_maximas,sem_sim,res_ini,res_max,inge,dias_de_incio_segun_el_mes=0,TBA=0;
        ...
        new resultados_simulacion().setVisible(true);
         proyecto_simulacion.resultados_simulacion.Simulacion(mes_inicio,anio_inicio,cuadrillas_iniciales,cuadrillas_maximas,sem_sim,res_ini,res_max,inge,dias_de_incio_segun_el_mes,sueldo_cua,dia_perdido,cuadrilla_fo,costo_aci,costo_per_perdido,multas,car_asada,costo_laboratorio,obra_perdida,sueldos_resi,pre_social,pre_popular,pre_resi,costo_maquina,costo_permiso,fact_utilidad,TBA);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventana_datos_llenado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventana_datos_llenado().setVisible(true);
            }
        });
    }
